pipeline {
    ...
    environment {
        IMAGE_NAME = "agnimanu/recommendationservice:${GIT_COMMIT}"
    }
    ...
    stages {
        ...
        stage('Git Checkout') {
            steps {
                git url: 'https://github.com/Manoj-agni/recommendationservice.git', branch: 'main'
            }
        }
            ...
            steps {
                withCredentials([usernamePassword(
                    ...
                    sh '''
                        ...
                        git clone https://$GIT_USERNAME:$GIT_PASSWORD@github.com/Manoj-agni/GitOps.git gitops
